...
// --------------- role helpers ---------------
export function mapRoleToDbRole(role: string): 'ADMIN' | 'OPERATOR' | 'LANDOWNER' {
...
export function buildDocumentFileKey(incidentId: string, fileName: string, fileSize?: string): string {
