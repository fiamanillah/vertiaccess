...
const CATEGORIES = {
    operator: [
        { value: 'unsafe_conditions', label: 'Unsafe Site Conditions' },
        { value: 'unreachable', label: 'Landowner Unreachable' },
        { value: 'billing_issue', label: 'Billing Issue' },
        { value: 'other', label: 'Other' },
    ],
    landowner: [
        { value: 'damage', label: 'Drone Crashed / Damaged Property' },
        { value: 'boundary_violation', label: 'Operator Flew Outside Boundaries' },
        { value: 'fraudulent_emergency', label: 'Fraudulent Emergency Claim' },
...
export function ReportModal({
    ...
    // Sync initial category if it changes
    React.useEffect(() => {
    ...
    const handleSubmit = async () => {
        ...
        toast.success('Investigation opened. Our team will review your report shortly.');
