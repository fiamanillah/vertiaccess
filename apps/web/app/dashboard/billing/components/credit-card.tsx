...
export function CreditCard({
    ...
    return (
        <div
            className={`relative w-full max-w-[380px] rounded-3xl overflow-hidden text-white shadow-2xl ${className}`}
        ...
        >
            ...
            <div className="relative z-10 h-full flex flex-col justify-between p-6">
                ...
                {/* Card number */}
                <div>
                    <div className="font-mono text-[18px] tracking-[0.22em] flex gap-5 text-white/90">
                        <span>••••</span>
                        <span>••••</span>
                        <span>••••</span>
