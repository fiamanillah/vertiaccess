...
import { Ticket, TicketStatus } from '@/app/dashboard/components/resolution/types';
...
export function ResolutionTable({ data, isLoading, baseUrl, isAdmin }: ResolutionTableProps) {
