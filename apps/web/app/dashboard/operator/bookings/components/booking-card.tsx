            ...
            <CardContent className="p-0">
                <div className="p-5 sm:p-6 space-y-4">
                    ...
                    <div className="flex items-start justify-between">
                        ...
                        <Badge className={cn("text-[9px] font-black uppercase tracking-widest border-none px-2 h-5", config.color)}>
                            {config.label}
                        </Badge>
                    </div>
                    ...
                    <div className="space-y-3">
                        <div className="flex items-start gap-2">
                            ...
                            <div className="space-y-0.5 min-w-0">
                                <p className="text-sm font-bold truncate tracking-tight">{booking.siteName}</p>
                                <p className="text-[10px] text-muted-foreground truncate uppercase tracking-widest font-medium">{booking.bookingReference}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                            <Badge variant="outline" className={cn(
                                ...
                                booking.useCategory === 'planned_toal' ? "bg-indigo-50 text-indigo-700" : "bg-amber-50 text-amber-700"
                            )}>
