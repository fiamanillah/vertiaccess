    ...
    return (
        <>
            ...
            <AlertDialog open={isConfirmOpen} onOpenChange={setIsConfirmOpen}>
                <AlertDialogContent className="max-w-[420px] p-0 overflow-hidden border-none shadow-2xl">
                    ...
                    <div className="p-6">
                        <AlertDialogHeader>
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <AlertDialogTitle className="text-xl font-black tracking-tight uppercase">Legally Binding Declaration</AlertDialogTitle>
                            </div>
                            <AlertDialogDescription className="text-sm font-bold text-foreground leading-relaxed">
                                You are declaring that no drone landed on or utilized this property. Landowners monitor their sites. 
                                <br /><br />
                                <span className="text-red-600">Fraudulent claims of non-usage will result in an automatic £500 penalty fee, and your VertiAccess Operator account will be permanently suspended.</span>
                            </AlertDialogDescription>
                        </AlertDialogHeader>
