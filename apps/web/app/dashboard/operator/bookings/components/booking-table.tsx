...
import { Calendar, Clock, MapPin, Eye, FileText, ExternalLink, ShieldCheck } from 'lucide-react';
    ...
    const columns: ColumnDef<Booking>[] = React.useMemo(() => [
        ...
        },
        {
            ...
            cell: ({ row }) => {
                ...
                if (status === 'APPROVED' && isEmergency && isPast && row.original.paymentStatus === 'pending') {
                    return (
