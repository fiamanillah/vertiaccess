        ...
        <div className="flex flex-col space-y-6 max-w-7xl mx-auto w-full p-2 pb-24 lg:pb-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="hidden lg:block lg:col-span-4 lg:sticky lg:top-24">
                    <BookingEngineCard site={site} className="sticky top-24 max-h-[calc(100vh-8rem)]" />
                </div>
            </div>
                ...
                <Drawer>
                    ...
                    <DrawerContent className="max-h-[85vh] bg-background">
                        ...
                        <div className="overflow-y-auto p-3 pb-8 flex-1">
                            <BookingEngineCard site={site} className="border-none shadow-none bg-transparent max-h-[70vh]" />
                        </div>
                    </DrawerContent>
                </Drawer>
            </div>
