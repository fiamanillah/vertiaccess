...
export function SearchHeader({
  ...
  return (
    <div className="sticky top-[16px] z-20 bg-background/80 backdrop-blur-xl border-b border-border/40 pb-4 pt-4 lg:pt-0">
      <div className="flex flex-col gap-4">
          ...
          >
            ...
            <div className="absolute inset-y-0 right-2 flex items-center gap-1.5">
              ...
              <Button
                type="submit"
                size="sm"
                className="h-8 rounded-xl px-4 font-bold shadow-md"
              >
                Search
              </Button>
            </div>
        ...
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center gap-3 overflow-x-auto pb-1 scrollbar-hide">
            ...
            <Select value={filters.radius} onValueChange={(val) => onFilterChange({ radius: val })}>
            ...
            <Select value={filters.siteType} onValueChange={(val) => onFilterChange({ siteType: val })}>
            ...
            <Select value={filters.autoApprove} onValueChange={(val) => onFilterChange({ autoApprove: val })}>
              <SelectTrigger className="w-[160px] h-9 rounded-xl bg-background border-border/60 text-xs font-semibold shadow-sm shrink-0">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="outline"
                  className="h-9 rounded-xl bg-background border-border/60 text-xs font-semibold shadow-sm shrink-0 px-3"
                >
            ...
            <AlertDialogHeader className="gap-4 relative z-10">
              ...
              <div className="space-y-1">
                ...
                <AlertDialogDescription className="text-sm text-muted-foreground/90 leading-relaxed pt-1">
                  ...
                  current position, we need access to your device's location. We
                  only use this while you are browsing.
                </AlertDialogDescription>
              </div>
            </AlertDialogHeader>
