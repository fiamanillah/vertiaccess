        ...
        <CardContent className="space-y-4 p-4 pt-0">
            ...
            <div className="grid gap-2.5">
              <div className="flex items-center gap-2.5">
                ...
                <div className="min-w-0">
                  <div className="text-xs font-medium text-muted-foreground leading-none mb-0.5">
                    Operator
                  </div>
                  <div className="text-sm font-semibold text-foreground truncate">
                    {ticket.operatorName || 'Unknown'}
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-sm font-semibold text-foreground truncate">
                    {ticket.assetManagerName || 'Unknown'}
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center gap-2 rounded-lg bg-muted/40 border border-border/40 p-3 text-muted-foreground">
            ...
            <p className="text-xs font-medium leading-tight">
              This investigation is mediated by the VertiAccess Safety Team. All
              decisions are final.
            </p>
          </div>
        </CardContent>
