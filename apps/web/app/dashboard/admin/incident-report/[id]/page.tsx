  ...
  thread: [
    {
      ...
      content:
        'The landing zone was completely blocked. I have photos of the equipment.',
    ...
    },
    {
      ...
      content:
        'Initial assessment: Reporter seems credible. CCTV verification needed.',
    ...
    },
    {
      ...
      senderName: 'Admin Sarah',
      content:
        'Hello Global Real Estate Group, we have received a report of equipment obstructing the Canary Wharf Helipad. Please provide site logs for May 14th.',
...
export default function AdminCaseDetail() {
  ...
  return <TriPaneLayout activeTicket={ticket} />
}
