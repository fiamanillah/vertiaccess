...
import { AssetOwnerContextColumn } from './components/asset-owner-context-column'
...
export default function AssetOwnerReviewPage({
  params,
}: {
    ...
    const loadData = async () => {
      try {
        ...
        if (isMounted) {
          ...
          router.push('/dashboard/admin/verifications/asset-owner')
        }
      } finally {
        if (isMounted) {
          setIsLoading(false)
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 bg-muted/10 py-6 md:py-8 relative">
        <div className="max-w-3xl mx-auto w-full px-4 space-y-6">
          <AssetOwnerContextColumn verification={verification} />
