...
interface ApprovedAssetOwnersTableProps {
    data: VerificationRequest[];
    isLoading: boolean;
}

export function ApprovedAssetOwnersTable({ data, isLoading }: ApprovedAssetOwnersTableProps) {
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem asChild>
                            <Link href={`/dashboard/admin/verifications/assetowner/review/${row.original.id}`}>
                                View Dossier
                            </Link>
                        </DropdownMenuItem>
