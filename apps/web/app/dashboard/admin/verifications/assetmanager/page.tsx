...
import { ApprovedAssetManagersTable } from './components/approved-asset-managers-table'
import { RejectedAssetManagersTable } from './components/rejected-asset-managers-table'
import {
  Pagination,
  PaginationContent,
  PaginationEllipsis,
...
export default function AssetManagerVerificationsPage() {
  ...
  React.useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        const result = await fetchAssetManagerData(status, currentPage)
  ...
  }, [activeTab, currentPage, fetchAssetManagerData])
    ...
    <div className="flex flex-col gap-8 container mx-auto p-4">
      ...
      >
        ...
        <TabsContent value="approved">
          <ApprovedAssetManagersTable data={verifications} isLoading={isLoading} />
        </TabsContent>

        <TabsContent value="rejected">
          <RejectedAssetManagersTable data={verifications} isLoading={isLoading} />
        </TabsContent>
      </Tabs>
