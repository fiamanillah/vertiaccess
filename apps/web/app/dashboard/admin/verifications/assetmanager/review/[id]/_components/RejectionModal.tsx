...
import { RejectionCheckbox } from './UiHelpers'
...
const REJECTION_LABELS: Record<string, string> = {
  ...
  business: 'Proof of business or entity is invalid or not found',
        ...
        <div className="space-y-4 py-2">
          <div className="space-y-2">
            ...
            <div className="grid gap-2">
              ...
              <RejectionCheckbox
                id="reason-business"
                label="Proof of business or entity is invalid or not found"
