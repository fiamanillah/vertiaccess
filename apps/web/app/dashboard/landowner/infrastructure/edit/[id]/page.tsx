...
export default function EditInfrastructureAssetPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    function mapBackendSiteToFormValues(s: any): FormValues {
        ...
        return {
            ...
            ownershipDocuments: mappedOwnershipDocuments, legalDeclaration: s.status === 'ACTIVE' ? true : !!s.acceptedLandownerDeclaration,
        };
    }
    ...
    async function onSubmit(data: FormValues) {
        ...
        const payload: any = {
            ...
            authorizedToGrantAccess: true, acceptedLandownerDeclaration: !!data.legalDeclaration,
        };
        ...
        <div className="flex w-full min-h-[calc(100vh-84px)] flex-col lg:flex-row">
            ...
            <div className="flex-1 lg:w-[45%] lg:flex-none border-r flex flex-col min-w-0">
                ...
                <div className="flex-1 p-4 sm:p-6 pb-24 lg:pb-12 overflow-y-auto">
                    ...
                    {currentStep === 1 && (
                        <SiteInformationForm form={form} isLoading={isLoading} onNext={nextStep} onCancel={() => router.push('/dashboard/landowner/infrastructure')} isIdentityLocked={siteStatus === 'active'} globalDisabled={siteStatus === 'pending'} />
                    )}
                    {currentStep === 2 && (
