...
import { CaseDetailView } from '@/app/dashboard/operator/resolution/components/case-file/case-detail-view';
...
export default function LandownerCasePage() {
    ...
    return <CaseDetailView ticket={ticket} backUrl="/dashboard/landowner/resolution" />;
}
