...
export default function AddInfrastructureAssetPage() {
  ...
  async function onSubmit(data: FormValues) {
    ...
    const payload: CreateSiteDto = {
      ...
      acceptedAssetOwnerDeclaration: !!data.legalDeclaration,
    }
    ...
    return (
      <div className="max-w-3xl mx-auto py-20 px-4 flex flex-col items-center text-center">
        ...
        <div className="flex gap-4">
          <Button variant="outline" asChild><Link href="/dashboard/assetowner/infrastructure">Back to Assets</Link></Button>
        ...
        <div className="flex-1 p-4 sm:p-6 pb-24 lg:pb-12 overflow-y-auto">
          {currentStep === 1 && (
            <SiteInformationForm
              ...
              isLoading={isLoading}
              onNext={nextStep}
              onCancel={() => router.push('/dashboard/assetowner/infrastructure')}
            />
          )}
