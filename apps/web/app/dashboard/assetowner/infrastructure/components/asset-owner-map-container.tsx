...
import { AssetOwnerMap } from './asset-owner-map';
import { AssetOwnerSiteList } from './asset-owner-site-list';
import { useRouter } from 'next/navigation';

interface AssetOwnerMapContainerProps {
    sites: DetailedSite[];
}

export function AssetOwnerMapContainer({ sites }: AssetOwnerMapContainerProps) {
    ...
    const handleNavigateToDetails = React.useCallback((siteId: string) => {
        router.push(`/dashboard/asset-owner/infrastructure/${siteId}`);
    }, [router]);
