...
function injectLeafletStyles() {
    if (document.getElementById('leaflet-custom-assetowner')) return;
    const style = document.createElement('style');
    style.id = 'leaflet-custom-assetowner';
    style.textContent = `
