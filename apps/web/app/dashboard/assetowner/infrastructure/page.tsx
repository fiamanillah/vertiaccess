            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem
                  ...
                  onClick={() =>
                    router.push(
                      `/dashboard/assetowner/infrastructure/${row.original.id}`,
                    )
                  }
                >
                ...
                <DropdownMenuItem
                  ...
                  onClick={() =>
                    router.push(
                      `/dashboard/assetowner/infrastructure/edit/${row.original.id}`,
                    )
                  }
                >
      ...
      <div className="flex flex-col gap-6 pt-2">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 border-b border-border/40">
          ...
          <div className="flex flex-col sm:flex-row items-end sm:items-center gap-3 shrink-0">
            ...
            >
              <Link href="/dashboard/assetowner/infrastructure/map">
            ...
            {!isVerified ? (
              ...
              >
                <Link href="/dashboard/assetowner/infrastructure/add">
                  <Plus className="mr-2 h-4 w-4" strokeWidth={3} />
                  Register new assets
                </Link>
              </Button>
