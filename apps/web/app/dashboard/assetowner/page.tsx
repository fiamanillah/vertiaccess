    ...
    async function loadDashboard() {
      try {
        ...
        const [pendingBookingsRes, upcomingBookingsRes, balanceRes, sitesRes, statsRes] =
          await Promise.all([
            bookingService.listAssetOwnerBookings({
              bucket: 'pending',
              limit: 5,
            }),
            bookingService.listAssetOwnerBookings({
        ...
        for (const b of pendingBookingsRes?.data || []) {
          ...
          attentionItems.push({
            ...
            link: '/dashboard/assetowner/scheduler',
          })
        }
  ...
  return (
    <div className="flex flex-1 flex-col gap-8 max-w-7xl mx-auto p-4">
          ...
          >
            ...
            <div className="flex w-full items-center justify-between gap-4">
              ...
              <Button size="sm" variant="destructive" asChild>
                <Link href="/dashboard/assetowner/balance">
                  Connect Stripe
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Link
          href="/dashboard/assetowner/infrastructure"
        ...
        <Link
          href="/dashboard/assetowner/scheduler"
          className="block transition-all duration-200 hover:scale-[1.005] active:scale-[0.995]"
        >
          <Card className="h-full border-border/60 shadow-sm">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        {/* Revenue */}
        <Link
          href="/dashboard/assetowner/balance"
          className="block transition-all duration-200 hover:scale-[1.005] active:scale-[0.995]"
        >
          <Card className="h-full border-border/60 shadow-sm">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
          ...
          <CardHeader className="border-b border-border/40 bg-muted/30 pb-4">
            <div className="flex items-center justify-between gap-4">
              ...
              <Button
                ...
                asChild
              >
                <Link href="/dashboard/assetowner/scheduler">
                  View Operations
                  <ArrowRight className="ml-1.5 h-3.5 w-3.5" />
                </Link>
              </Button>
