...
export default function AssetOwnerCasePage() {
  ...
  const replyVisibility = ticket.reporterRole === 'assetowner' ? 'reporter' : 'target'

  return (
    <CaseDetailView
      ticket={ticket}
      backUrl="/dashboard/assetowner/incident-report"
