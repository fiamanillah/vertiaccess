...
export default function AssetManagerOperationsPage() {
  ...
  const loadBookings = React.useCallback(async () => {
    ...
    try {
      const response = await bookingService.listAssetManagerBookings({
  ...
  const handleReview = (booking: Booking) => {
    router.push(`/dashboard/assetmanager/scheduler/${booking.id}/review`)
  }
