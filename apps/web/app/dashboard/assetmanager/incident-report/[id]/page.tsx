...
export default function AssetManagerCasePage() {
  ...
  const replyVisibility = ticket.reporterRole === 'assetmanager' ? 'reporter' : 'target'

  return (
    <CaseDetailView
      ticket={ticket}
      backUrl="/dashboard/assetmanager/incident-report"
