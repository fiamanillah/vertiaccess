...
export default function AuthCardLayout({
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center p-4 md:p-8 bg-zinc-50 dark:bg-zinc-950 overflow-hidden">
            ...
            <Card className="relative w-full max-w-4xl overflow-hidden rounded-2xl border bg-card/75 backdrop-blur-md shadow-2xl grid md:grid-cols-12 min-h-0 md:min-h-[600px] z-10 py-0">
                        ...
                        {backLink && (
                            <Link
                                ...
                                className={cn(
                                    ...
                                    'self-start text-primary-foreground/80 hover:text-primary-foreground hover:bg-primary-foreground/10 transition-colors hidden md:inline-flex -ml-2'
                                )}
                            >
                ...
                <div className="col-span-12 md:col-span-7 flex flex-col justify-center p-6 sm:p-8 md:p-10 relative overflow-y-auto max-h-[90vh] md:max-h-[750px] custom-scrollbar">
