...
import { Plane, Landmark, ArrowLeft, ArrowRight } from 'lucide-react';

interface RoleSelectionProps {
    onBack: () => void;
    onSelectRole: (role: 'operator' | 'landowner') => void;
    onLogin: () => void;
}

export function RoleSelection({ onBack, onSelectRole, onLogin }: RoleSelectionProps) {
    return (
                        ...
                        >
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-slate-500 leading-snug">
                                    Discover and book TOAL & Emergency and Recovery sites for BVLOS
                                    missions.
                                </p>
                            </div>
                        ...
                        >
                            ...
                            <div className="flex-1">
                                <div className="flex items-center gap-3 mb-1">
                                    <h4 className="font-bold text-slate-900 text-lg">Landowner</h4>
