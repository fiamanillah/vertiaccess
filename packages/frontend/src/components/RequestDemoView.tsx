...
export function RequestDemoView({ onSuccess }: { onSuccess: () => void }) {
    ...
    return (
        <div className="py-20 lg:py-32 bg-muted/10 min-h-[calc(100vh-80px)]">
            <div className="max-w-300 mx-auto px-6 grid lg:grid-cols-2 gap-16 items-start">
                {/* Content Side */}
                    ...
                    <div className="pt-8 space-y-10">
                        <div className="flex gap-5 items-start">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground leading-relaxed">
                                    Whether you are a drone operator, landowner, estate manager, or
                                    public authority, we will focus on the features most relevant to
                                    your use case.
                                </p>
                            </div>
                        </div>
                        <div className="flex gap-5 items-start">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground leading-relaxed">
                                    Discuss real-world operational workflows, land access
                                    coordination, and evidence generation for insurance or
                ...
                <div className="bg-white p-8 md:p-10 rounded-3xl border border-border shadow-xl shadow-primary/5">
                    <div className="mb-10">
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            Complete the form below and our team will be in touch to arrange your
                            demo.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                className="w-full p-4 border border-border rounded-xl outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all bg-muted/5 min-h-30 resize-none"
                        ...
                        <button
                            type="submit"
                            className="btn-primary w-full h-14 text-lg font-bold flex items-center justify-center gap-2 group shadow-lg shadow-primary/20"
                        >
                            Send Request
