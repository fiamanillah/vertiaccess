...
import { Search, FileText, CheckCircle, Globe, Shield, BarChart3 } from 'lucide-react';
    ...
    return (
        <div className="space-y-0">
            ...
            <section className="relative overflow-hidden w-full h-[100vh] min-h-[600px] flex items-center justify-center py-20">
                ...
                <div className="absolute inset-0 -z-10 bg-[radial-gradient(45%_45%_at_50%_50%,rgba(79,70,229,0.15)_0%,rgba(255,255,255,0)_100%)]" />
                        ...
                        <div className="flex gap-6 items-start p-6 rounded-2xl bg-muted/20 border border-transparent hover:border-primary/10 transition-colors group">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground leading-relaxed">
                                    ...
                                    during non-nominal events, supporting safer and more predictable
                                    operations.
                                </p>
                            </div>
                        </div>
                ...
                <div className="max-w-[1200px] mx-auto px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-white/80 mb-8">
                            A structured workflow for accessing ground infrastructure at scale.
                        </p>
                        ...
                        {howItWorksRole === 'operator' ? (
                            <>
                                ...
                                <Step
                                    icon={CheckCircle}
                                    number="3"
                                    title="Receive operational access"
                                    text="Get approved access to landowner sites for your operational scenarios, with auditable confirmation to support regulatory applications and manage bookings."
                                    darkBackground
                                />
                            </>
                        ) : (
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {loadingPlans ? (
                            ...
                            plans
                                ...
                                .map(plan => {
                                    const staticData = planStaticData[plan.name] || {
                                        features: [],
                                    };
                                    return (
                                        <PricingCard
            ...
            <section className="py-24 bg-primary text-white">
                <div className="max-w-[1200px] mx-auto px-6 text-center">
                    ...
                    <p className="text-white/80 mb-10 max-w-xl mx-auto">
                        Join professional drone operators and landowners using VertiAccess to
                        coordinate compliant take-off, landing, and contingency access.
                    </p>
