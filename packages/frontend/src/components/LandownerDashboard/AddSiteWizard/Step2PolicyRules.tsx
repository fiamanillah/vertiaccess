import { FileText, Info, Upload, X, CheckCircle, ShieldCheck } from 'lucide-react';
                ...
                <div className="space-y-4">
                    ...
                    <div className="p-4 bg-blue-50 border border-blue-100 rounded-xl flex items-start gap-3">
                        ...
                        <p className="text-sm text-blue-900 leading-relaxed">
                            ...
                            (earliest:{' '}
                            {new Date(getMinimumAllowedDate() + 'T00:00:00').toLocaleDateString(
                                'en-GB',
                                {
                                    weekday: 'short',
                                    day: 'numeric',
                    ...
                    <label className="flex items-center gap-3 p-4 bg-white border border-slate-200 rounded-xl cursor-pointer hover:border-blue-600/30 transition-all group">
                        ...
                        />
                        <div>
                            <p className="text-sm font-bold text-slate-700">Permanent Activation</p>
                ...
                {siteType !== 'emergency' && (
                    <div className="space-y-4 pt-4 border-t border-slate-100">
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-sm font-bold text-slate-700">Contingency Support</p>
                        </div>

                        <div className="p-5 bg-blue-50 border border-blue-100 rounded-2xl">
                            <p className="text-sm text-blue-900 leading-relaxed">
                                Enabling emergency support makes your site accomodate both TOAL and
                                emergency recovery landings.
                            </p>
                        </div>
