    ...
    return (
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-xl  flex items-center justify-center p-4 z-50">
            <motion.div
                ...
                className="bg-white border border-slate-200 rounded-3xl max-w-5xl w-full max-h-[90vh] overflow-hidden shadow-2xl shadow-slate-900/10 flex flex-col isolation-isolate"
            >
                ...
                <div className="flex-1 overflow-y-auto p-4 md:p-5 space-y-4 rounded-b-3xl">{children}</div>
            </motion.div>
        </div>
    );
}
